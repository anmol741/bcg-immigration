      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-[#c9a84c] text-[#0a1628] rounded-full flex items-center justify-center shadow-xl shadow-[#c9a84c]/30"
            initial={{ scale: 0, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            exit={{ scale: 0, opacity: 0 }}
            whileHover={{ scale: 1.15, boxShadow: "0 0 25px rgba(201,168,76,0.5)" }}
            whileTap={{ scale: 0.9 }}
